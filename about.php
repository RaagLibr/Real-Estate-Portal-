      ...
      <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5"  data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              ...
              <img src="images/person.jpg" alt="Image" class="img-fluid rounded mb-4">

              <div class="text">

                <h2 class="mb-2 font-weight-light text-black h4">prof.Bhupendra Jogi sir.</h2>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5"  data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Mrs.jogi mam.</h2>
                <span class="d-block mb-3 text-white-opacity-05">Real Estate Agent</span>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5"  data-aos="fade-up" data-aos-delay="400">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">prof.Ram Ghayalkar </h2>
                <span class="d-block mb-3 text-white-opacity-05">Real Estate Agent</span>
