...
<?php 
  ...
  if(isset($_POST['submit'])) {
    ...
    OR empty($_POST['home_type']) OR empty($_POST['year_build']) OR empty($_POST['type'])
     OR empty($_POST['price_sqfit']) OR empty($_POST['description'])) {
      ...
      sq_ft, home_type, year_build, type, description, price_sqfit, admin_name, image) 
      VALUES (:name, :location, :price, :beds, :baths, :sq_ft, :home_type, 
      :year_build, :type, :description, :price_sqfit, :adminname, :image)");
          ...
          <div class="card">
            <div class="card-body">
                    ...
                    <form method="POST" action="create-properties.php" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="year_build" id="form2Example1" class="form-control" placeholder="Year Build" />
                        </div> 
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="price_sqfit" id="form2Example1" class="form-control" placeholder="Price Per SQ FT" />
                        </div> 
