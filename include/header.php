...
<!--   <?php echo APPURL; ?>   we added this file so it will call in register.php, register.php will use header and footer -->

<?php

session_start();
define("APPURL", "http://localhost/REMS/homeland");
...
<html lang="en">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    ...
    <title>Homeland  &mdash;By Ragini &#10084;&#65039; </title>
    <meta charset="utf-8">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown arrow-top">
                      <?php foreach($allCategories as $category) : ?>
                        <!-- i will send that category in name , it will present data dynamically (the value we put in database table)-->
                  ...
                  <?php if(isset($_SESSION['username'])):  ?>
                    ...
                    <ul class="dropdown arrow-top ">
                      ...
                      <li><a href="<?php  echo APPURL; ?>/user/request.php">Requests</a></li>
