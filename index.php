        ...
        <div class="row">
          <form class="form-search col-md-12" method="post" action="search.php" style="margin-top: -100px;">
            <div class="row  align-items-end">
              ...
              <div class="col-md-3">
                <label for="select-city">Select City or State</label>
                <div class="select-wrap">
                  <span class="icon icon-arrow_drop_down"></span>
              ...
              <div class="p-4 property-body">
                ...
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  <li>
                    ...
                    <span class="property-specs-number"><?php $prop->beds; ?></span>
                    
                  </li>
                  <li>
                    <span class="property-specs">Baths</span>
                    <span class="property-specs-number"><?php $prop->baths; ?></span>
                    
                  </li>
                  <li>
                    <span class="property-specs">SQ FT</span>
                    <span class="property-specs-number"><?php $prop->sq_ft; ?></span>
