...
{
  $id=$_GET['id'];
//display details for properties
...
//to see the image query is excecuting or not we use to 
 //var_dump($allImages);
...
//check if user add current propertie to favourite
            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  ...
                  <strong class="d-block"><?php echo $allDetails->year_build; ?></strong>
                </div>
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  <span class="d-inline-block text-black mb-0 caption-text">Price/Sqft</span>
                  <strong class="d-block">&#x20B9;<?php echo $allDetails->price_sqfit; ?></strong>
                </div>
              </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-white widget border rounded">
              ...
              <?php if(isset($_SESSION['user_id'])) : ?>
                ...
                <p>you already send requests to this property, so you can not send anymore requests.</p>
             ...
             <?php else: ?>
              <p>login in order to send request  to this property.</p>
             <?php endif; ?>
            </div>
            ...
            <form action="favs/addfav.php" method="post" class="form-contact-agent">

                <div class="form-group">
                  <input type="hidden" id="name" value="<?php echo $id; ?>" name="prop_id" class="form-control">
                </div>
                <div class="form-group">
              ...
              <?php if($check->rowCount()>0):  ?>
                <div class="form-group">
                  <a class="btn btn-primary text-white" href="favs/delete-fav.php?prop_id=<?php echo $id; ?>&user_id=<?php echo  $_SESSION['user_id']; ?>" >added to fav</a>
                </div>
             <?php else: ?>
          
                 <div class="form-group">
                  <input type="submit" id="phone"  name="submit" class="btn btn-primary" value="add to favourite">
                  </div>
             <?php endif; ?>
